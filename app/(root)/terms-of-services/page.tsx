		...
		<section className="w-full h-fit py-7 pb-24 bg-white flex flex-col gap-4 items-center justify-start md:px-14 lg:px-24 max-md:px-4">
			...
			<section className="w-full">
				...
				<span>
					...
					Agreement. When we speak of 'Flashcall' , ‘we’, ‘us’, and ‘our’, we
					mean Flashcall – a company incorporated in India. Please read the
					Agreement and all other rules and policies made available or published
					on the Platform as they shall govern Your use of the Platform and the
			...
			<section className="w-full h-fit flex flex-col gap-4 items-start justify-center mt-10">
				...
				<p>
					{aboutPlatform.para2} <strong>"Flashcall Features"</strong> or{" "}
					<strong>"Services</strong> under this Agreement.
				</p>
